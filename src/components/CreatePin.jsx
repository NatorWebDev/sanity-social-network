...
export default function CreatePin({ user }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      {fields && (
        <p className="text-red-500 mb-5 text-xl transition-all duration-150 ease-inf">
          Please Fill in all the fields.
        </p>
      )}

      <div className="flex lg:flex-row flex-col justify-center itmes-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        <div className="bg-[#ddddee] p-3 flex flex-0.7 w-full">
          '
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-[420px]">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                />
                <button
                  className="absolute bottom-3 right-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-all duration ease-in-out p-3"
                  onClick={() => {
                    setImageAsset(null);
                  }}
                >
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <div className="flex flex-col">
            <div>
              <p className="mb-2 fontsemibold text-lg sm:text-xl">
                Choose Pin category
              </p>
              <select
                onChange={(e) => {
